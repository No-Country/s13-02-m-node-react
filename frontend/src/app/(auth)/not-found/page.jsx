...
const page404 = () => {
  return (
    <div className="h-screen w-screen bg-rich-black-500 flex items-center">
      <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-white">
        <div class="w-full lg:w-1/2 mx-8">
          <div class="text-9xl text-indigo-500 font-dark font-extrabold mb-8">
            404
          </div>
          ...
          <a
            href="/"
            className="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-indigo-500 active:bg-indigo-600 hover:bg-indigo-700"
          >
